...
export const A2I_BANNER_MANIFEST = {
  about: {
    variant: "gradient-glow" as const,
    eyebrow: "Who We Are",
  ...
  blog: {
    ...
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/blog-telemetry.jpg`,
  ...
  client: {
    ...
    title: "Trusted by Innovators and Industry Leaders",
    description: "Explore the global enterprises, high-growth startups, and tech visionary brands that rely on A2ICoders to power their critical engineering operations.",
    supportingCopy: "* Contractually protected under strict enterprise SLAs.",
    chips: ["FinTech", "SaaS Enterprises", "Healthcare Systems"],
    stats: [{ value: "98%", label: "Retention Rate" }, { value: "50+", label: "Global Clients" }],
    actions: [{ label: "Partner Engagements", href: "/contact", variant: "secondary" as const, icon: React.createElement(ArrowRight, { className: "h-4 w-4" }) }],
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/clients-global.jpg`,
    imageAlt: "Abstract network connectivity graph mapping worldwide partnerships",
    imagePriority: false,
    imagePosition: "center"
  },
  ...
  partner: {
    ...
    icon: React.createElement(Globe, { className: "h-3.5 w-3.5 text-primary" }),
    title: "Co-Orchestrating the Cloud Infrastructure Era",
    description: "A2ICoders partners with premium cloud operators, security foundations, and industry leaders to integrate absolute dependability.",
    supportingCopy: "* Deep technology alliance integrations across multi-vendor networks.",
    chips: ["AWS Partner Network", "Open Source Alliance", "SaaS Co-Marketing"],
    stats: [{ value: "Gold", label: "Tier Integration" }, { value: "10+", label: "Ecosystem Partners" }],
    actions: [{ label: "Alliance Framework", href: "/contact", variant: "secondary" as const, icon: React.createElement(ArrowRight, { className: "h-4 w-4" }) }],
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/partner-globe.jpg`,
    imageAlt: "Glowing digital holographic wireframe globe indicating connected technology hubs",
    imagePriority: false,
    imagePosition: "center"
  },
  ...
  "case-study": {
    ...
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/casestudy-grid.jpg`,
  ...
  event: {
    variant: "classic" as const,
    eyebrow: "Tech Symposiums",
    icon: React.createElement(Building2, { className: "h-3.5 w-3.5 text-primary" }),
    title: "Sharing Collective Intelligence with the Ecosystem",
    description: "Join A2ICoders at upcoming open-source developer summits, engineering workshops, and global technology panels.",
    supportingCopy: "* Interactive streaming channels active during global roundtables.",
    chips: ["Developer Summits", "Live Code Streams", "Architecture Panels"],
    stats: [{ value: "4", label: "Annual Summits" }, { value: "Live", label: "Broadcasts" }],
    actions: [{ label: "Register for Next Event", href: "#register", variant: "primary" as const, icon: React.createElement(ArrowRight, { className: "h-4 w-4" }) }],
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/events-stage.jpg`,
    imageAlt: "Modern tech conference amphitheater with minimal neon projection setups",
    imagePriority: false,
    imagePosition: "center"
  },
  ...
  industry: {
    ...
    icon: React.createElement(Building2, { className: "h-3.5 w-3.5 text-primary" }),
    title: "Bespoke Architectures Tailored to Specific Sectors",
    description: "We decouple vertical industry compliance requirements and couple them with lightning-fast cloud delivery configurations.",
    supportingCopy: "* Engineered to natively clear global security audits.",
    chips: ["FinTech Compliance", "Logistics Routings", "EdTech Portals"],
    stats: [{ value: "100%", label: "Audit Cleared" }, { value: "HIPAA/GDPR", label: "Compliant" }],
    actions: [{ label: "Explore Domain Solutions", href: "/specialization", variant: "secondary" as const, icon: React.createElement(ArrowRight, { className: "h-4 w-4" }) }],
    imageSrc: `${CLOUDINARY_IMAGE_BASE}/banners/industry-sectors.jpg`,
    imageAlt: "Minimalist layout dividing modern industrial segments using clean isometric vectors",
    imagePriority: false,
    imagePosition: "center"
  },
